...
detailed one by \fix{merging it with the existing models in the
  ...
  etc.).}\am{it's probably not very important to say here that this is
  done one at a time; your tool could in principal merge many of
  them}. After every merge step, the analyst re-runs the analysis on
