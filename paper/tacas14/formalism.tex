...
at its interface, and \textit{stores} some set of data $D$\fix{ that
  can be transmitted}{. Data can flow from one} to another module
\fix{by \textit{invoking} the latter's operations}{only by means of
  operation \textit{invocations}; this enables our system to
  ...
  paragraphs below, where it talks about passing arguments.}
