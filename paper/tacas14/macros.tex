...
\def\note#1#2{%
\ifx \mode \moderev
  \textcolor{blue}{\scriptsize [\textbf{#1}: #2]}%
\else
\fi
}
...
\newcommand{\fixed}[2]{%
\ifx \mode \moderev
  \textcolor{red}{PROBLEM: #1}; \textcolor{blue}{FIX: #2}
\else
\fi
}
...
%\newcommand{\comment}[2]{\begin{scriptsize}{\textcolor{red}{[COMMENT (#1): #2]}}\end{scriptsize}}           
% \newcommand{\todo}[1]{\textcolor{blue}{[\textbf{TODO}: #1]}}   
% \newcommand{\del}[1]{\textcolor{red}{\sout{#1}}}
%% \newcommand{\del}[1]{}
%% \newcommand{\fix}[2]{\del{#1}\textcolor{blue}{#2}}
%% \newcommand{\sst}[1]{\scriptsize{#1}}
