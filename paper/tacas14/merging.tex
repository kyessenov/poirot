...
more generic representation of the other. \ek{For example,
\textsf{NYTimes} can be regarded as a specialized kind of
...
cookie, \textsf{Counter} can be treated as a kind of \textsf{Cookie}.}
...
% \textsf{Client}'s perspective, the merged component
